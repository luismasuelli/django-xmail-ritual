    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='Pickled message being sent (it is a pickled EmailMessage instance encoded in base 64)', verbose_name='Pickled email')),
                ('state', models.CharField(default=b'pending', help_text='Current state of the message (pending, already sent, or failed)', max_length=10, verbose_name='Message state', choices=[(b'pending', 'Pending'), (b'busy', 'Busy'), (b'failed', 'Failed'), (b'succeeded', 'Succeeded')])),
